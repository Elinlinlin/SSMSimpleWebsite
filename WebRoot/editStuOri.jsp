...
<script>
	$(function() {
		...
		$('#backid').click(function() {
			...
			window.location.href = "stu/findOriStus.action?uid="+uid;
		});
	});
...
<body>
	...
	<h3 align="center">员工部门管理系统</h3>
		<form action="stu/updateStuOri.action" method="GET">
		<input type="text" name="role" id="role"  value="您的工号"/>
			<table class="table table-bordered table-hover definewidth m10">
				...
				<tr>
					...
					<td><input type="text" name="pay" value="${stu.pay}" /></td>
				</tr>
				<tr>
